...
(function () {
  ...
  rulesPack('ru', {
    ...
    rules_ethics_warn_html:
      '⚠️ Статьи с плагиатом, дублирующие уже опубликованные работы или поданные одновременно в несколько журналов — отклоняются автоматически.',
    ...
    faq_q9_a_html:
      'Нет. Применяется двойное слепое рецензирование: авторы не знают рецензентов, а рецензенты — авторов. Это обеспечивает объективность оценки.',
  ...
  rulesPack('en', {
    ...
    rules_ethics_warn_html:
      '⚠️ Articles with plagiarism, duplication of published work or simultaneous submission to several journals will be rejected automatically.',
  ...
  rulesPack('uz', {
    ...
    rules_ethics_warn_html:
      '⚠️ Plagiatlangan, boshqa joyda chiqgan yoki bir vaqtning oʻzida bir necha jurnalga yuborilgan maqolar avtomatik rad etiladi.',
