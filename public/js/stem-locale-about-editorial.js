...
(function () {
  const pack = {
    uz: {
      about_body_html:
        '<p>«Markaziy Osiyo STEM jurnali» — yiliga ikki marta ingliz, o‘zbek va rus tillarida elektron shaklda chiqadigan ilmiy nashr. Jurnal oliy o‘quv yurtlari o‘qituvchilari, tadqiqotchilari va mutaxassislari uchun mo‘ljallangan hamda keng mutaxassislar doirasiga qaratilgan professional ilmiy-tahliliy nashr hisoblanadi.</p>'
      ...
      editorial_lead: 'Central Asian Journal of STEM tahririyati.',
      editorial_body_html:
        '<h2>Bosh muharrir</h2>'
    ...
    en: {
      about_body_html:
        '<p>The <em>Central Asian Journal of STEM</em> is a semi-annual scientific publication issued electronically in English, Uzbek, and Russian. It is aimed at faculty, researchers, and specialists of higher education institutions and serves as a professional scientific and analytical journal for a broad audience of experts.</p>'
      ...
      editorial_lead: 'Editorial office of the Central Asian Journal of STEM.',
      editorial_body_html:
  ...
  if (typeof window !== 'undefined') {
    window.__STEM_ABOUT_EDITORIAL_PACK = pack;
  }
})();
